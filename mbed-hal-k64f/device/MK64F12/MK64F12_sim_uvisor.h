...
#define BITBAND_ADDRESS32(Reg,Bit) ((uint32_t volatile*)(0x42000000u + (32u*((uint32_t)(Reg) - (uint32_t)0x40000000u)) + (4u*((uint32_t)(Bit)))))
#define BITBAND_ADDRESS16(Reg,Bit) ((uint16_t volatile*)(0x42000000u + (32u*((uint32_t)(Reg) - (uint32_t)0x40000000u)) + (4u*((uint32_t)(Bit)))))
#define BITBAND_ADDRESS8(Reg,Bit)  ((uint8_t  volatile*)(0x42000000u + (32u*((uint32_t)(Reg) - (uint32_t)0x40000000u)) + (4u*((uint32_t)(Bit)))))
...
#define BW_SIM_SCGC1_UART4(x, v) uvisor_bitband(BITBAND_ADDRESS32(HW_SIM_SCGC1_ADDR(x), BP_SIM_SCGC1_UART4), v)
#undef  BW_SIM_SCGC1_UART5
#define BW_SIM_SCGC1_UART5(x, v) uvisor_bitband(BITBAND_ADDRESS32(HW_SIM_SCGC1_ADDR(x), BP_SIM_SCGC1_UART5), v)

/* SIM_SCGC4 */
#undef  BW_SIM_SCGC4_UART0
#define BW_SIM_SCGC4_UART0(x, v) uvisor_bitband(BITBAND_ADDRESS32(HW_SIM_SCGC4_ADDR(x), BP_SIM_SCGC4_UART0), v)
#undef  BW_SIM_SCGC4_UART1
#define BW_SIM_SCGC4_UART1(x, v) uvisor_bitband(BITBAND_ADDRESS32(HW_SIM_SCGC4_ADDR(x), BP_SIM_SCGC4_UART1), v)
#undef  BW_SIM_SCGC4_UART2
#define BW_SIM_SCGC4_UART2(x, v) uvisor_bitband(BITBAND_ADDRESS32(HW_SIM_SCGC4_ADDR(x), BP_SIM_SCGC4_UART2), v)
#undef  BW_SIM_SCGC4_UART3
#define BW_SIM_SCGC4_UART3(x, v) uvisor_bitband(BITBAND_ADDRESS32(HW_SIM_SCGC4_ADDR(x), BP_SIM_SCGC4_UART3), v)

/* SIM_SCGC5 */
#undef  BW_SIM_SCGC5_PORTA
#define BW_SIM_SCGC5_PORTA(x, v) uvisor_bitband(BITBAND_ADDRESS32(HW_SIM_SCGC5_ADDR(x), BP_SIM_SCGC5_PORTA), v)
#undef  BW_SIM_SCGC5_PORTB
#define BW_SIM_SCGC5_PORTB(x, v) uvisor_bitband(BITBAND_ADDRESS32(HW_SIM_SCGC5_ADDR(x), BP_SIM_SCGC5_PORTB), v)
#undef  BW_SIM_SCGC5_PORTC
#define BW_SIM_SCGC5_PORTC(x, v) uvisor_bitband(BITBAND_ADDRESS32(HW_SIM_SCGC5_ADDR(x), BP_SIM_SCGC5_PORTC), v)
#undef  BW_SIM_SCGC5_PORTD
#define BW_SIM_SCGC5_PORTD(x, v) uvisor_bitband(BITBAND_ADDRESS32(HW_SIM_SCGC5_ADDR(x), BP_SIM_SCGC5_PORTD), v)
